...
define('DB_USER','gambio');
define('DB_PASSWORD','gambio');
define('DB_DATABASE','gambio_copy');
...
class db_handler {
  ...
  public function __construct() {
    exec('mysql -h' . DB_HOST . ' -u' . DB_USER . ' --password=' . DB_PASSWORD . ' ' . DB_DATABASE . '< tests/gambio_copy.sql');
