...
class ModuleBarzahlenTest extends PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->object = $this->getMock('barzahlen', array('getGambioVersion'));
        $this->object->expects($this->any())
            ->method('getGambioVersion')
            ->will($this->returnValue('v2.0.0.0'));
    }
    ...
    public function testPaymentActionWithVaildXml()
    {
        ...
        $this->object = $this->getMock('barzahlen', array('createApi', 'getGambioVersion'));
